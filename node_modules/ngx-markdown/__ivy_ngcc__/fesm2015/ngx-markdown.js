...
let MarkdownService = class MarkdownService {
    ...
    compile(markdown, decodeHtml = false, markedOptions = this.options) {
        ...
        const compiled = parse(decoded, markedOptions);
...
export { KatexOptions, LanguagePipe, MarkdownComponent, MarkdownModule, MarkdownPipe, MarkdownService, MarkedOptions, PrismPlugin, SECURITY_CONTEXT, errorKatexNotLoaded, errorSrcWithoutHttpClient };
